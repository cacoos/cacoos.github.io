...
const TEXTS = [
  ...
  "No hay mucha caption aquí. Foto bonita, salgo medio flaco y pálido pero puta que teníamos hambre jajajjaj (cuando fuimos a comer burgirsss). Ya pasó la mitad del viaje, y yo debería estar en Chile. Ojalá no esté con alguna crisis por no tenerte, te extraño ahora cuando escribo este mensaje y seguramente te extraño mucho más cuando estes leyendo esto. Tkm. PD: que complicao es escribir pal futuro, mis respetos a los q mandaban cartas",
  "Estos tragos fueron los culpables po, no era yo el curao, seguro tenían droga horoscópica o algo. Todavía no descifro por qué cresta vemos la luna a veces jajajajajj. A estas alturas ya estai nacionalizada con carnet de vacunación europeo y volas, pero no importa. Si te quedai alla, te voy a ver. Disfruta feita",
